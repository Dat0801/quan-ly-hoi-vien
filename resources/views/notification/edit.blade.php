<x-app-layout>
    <div class="d-flex align-items-start" style="margin-right: 20px;">
        <div class="p-4 bg-white shadow-sm rounded-lg w-100" style="max-height: 85vh; overflow-y: auto;">
            ...
            <form id="meetingForm" action="{{ route('notification.update', $notification->id) }}" method="POST"
                    ...
                    <div class="col-lg-12">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <input type="text" id="title" name="title"
                                value="{{ old('title', $notification->title) }}" placeholder="Nhập tiêu đề thông báo"
                                ...
                                <div class="flex-grow-1">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="format_email" name="format"
                                            value="email"
                                            {{ old('format', $notification->format) === 'email' ? 'checked' : '' }}
                                            required>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="format_notification"
                                            ...
                                            {{ old('format', $notification->format) === 'notification' ? 'checked' : '' }}
                                            required>
                            ...
                            <div class="col-lg-4 d-flex align-items-center mb-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <input type="datetime-local" id="custom_send_time" name="send_time"
                                        value="{{ old('send_time', $notification->sent_at) }}"
                    ...
                    <div class="col-lg-12">
                        <div class="d-flex mb-3">
                            ...
                            <textarea id="content" name="content" rows="5" placeholder="Nhập nội dung thông báo"
                                class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1">{{ old('content', $notification->content) }}</textarea>
                        </div>
                    </div>
                                            ...
                                            <tr data-type="{{ $participant->type_name }}"
                                                ...
                                                <td style="text-align: center">
                                                    <input type="checkbox"
                                                        ...
                                                        {{ in_array($participant->id, $notification->recipients->pluck('recipientable_id')->toArray()) &&
                                                        in_array($participant->type, $notification->recipients->pluck('recipientable_type')->toArray())
                                                            ? 'checked'
                                                            : '' }}>
                                                    <input type="hidden"
