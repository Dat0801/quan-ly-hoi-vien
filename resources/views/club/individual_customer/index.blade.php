<x-app-layout>
    <div class="d-flex align-items-start">
                ...
                <div class="tab-pane fade show active" id="individual-customer" role="tabpanel">
                    <div class="bg-white sm:rounded-lg">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <form id="statusSelectForm" method="GET" action="{{ route('club.individual_customer.index', $club->id) }}" class="d-flex" onchange="this.submit()">
                            ...
                            <form id="customerSearchForm" method="GET" action="{{ route('club.individual_customer.index', $club->id) }}" class="d-flex">
        ...
        <div class="d-flex flex-column justify-content-between ms-4 bg-white sm:rounded-lg" id="addNewButtonContainer">
            <a href="{{ route('club.individual_customer.create', $club->id) }}" class="btn btn-white d-flex flex-column align-items-center justify-content-center border-0 p-3" style="color: #FF7506; border-color: #FF7506; width: 80px; text-align: center;" id="addCustomerButton">
