<x-app-layout>
    ...
    <div class="d-flex align-items-start" style="margin-right: 110px;">
        <div class="p-4 bg-white shadow-sm rounded-lg w-100" style="max-height: 85vh; overflow-y: auto;">
            <h1 style="font-family: 'Roboto', sans-serif; font-size: 32px; font-weight: 700; line-height: 38.4px; color: #803B03;">Thêm câu lạc bộ</h1>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="border mb-3" style="border-radius: 10px; padding: 20px;">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <label for="club_code" class="form-label mb-0 me-2" style="width: 250px;">Mã câu lạc bộ <span class="text-danger">*</span></label>
                                <input type="text" id="club_code" name="club_code" value="{{ old('club_code') }}" placeholder="Nhập mã câu lạc bộ" class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1" required>
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <label for="name_vi" class="form-label mb-0 me-2" style="width: 250px;">Tên Tiếng Việt <span class="text-danger">*</span></label>
                                <input type="text" id="name_vi" name="name_vi" value="{{ old('name_vi') }}" placeholder="Nhập tên tiếng Việt" class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1" required>
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <input type="text" id="name_en" name="name_en" value="{{ old('name_en') }}" placeholder="Nhập tên tiếng Anh (nếu có)" class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <input type="text" id="name_abbr" name="name_abbr" value="{{ old('name_abbr') }}" placeholder="Nhập tên viết tắt (nếu có)" class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <input type="text" id="address" name="address" value="{{ old('address') }}" placeholder="Nhập địa chỉ" class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <input type="text" id="established_decision" name="established_decision" value="{{ old('established_decision') }}" placeholder="Nhập quyết định thành lập" class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1">
