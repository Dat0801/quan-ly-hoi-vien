<x-app-layout>
    ...
    <div class="d-flex align-items-start" style="margin-right: 110px;">
        <div class="p-4 bg-white shadow-sm rounded-lg w-100" style="max-height: 85vh; overflow-y: auto;">
            ...
            <form action="{{ route('club.business_customer.store', $club->id) }}" method="POST">
                @csrf
                <div class="row">
                        ...
                        <div class="border" style="border-radius: 10px; padding: 20px;">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <input type="text" id="branch_address" name="branch_address"
                                    value="{{ old('branch_address') }}" placeholder="Nhập địa chỉ văn phòng giao dịch"
                                    class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <input type="number" id="charter_capital" name="charter_capital"
                                    value="{{ old('charter_capital') }}" placeholder="Nhập vốn điều lệ"
                                    class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1"
                                    step="0.01">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <input type="number" id="pre_membership_revenue" name="pre_membership_revenue"
                                    value="{{ old('pre_membership_revenue') }}"
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <input type="email" id="email" name="email" value="{{ old('email') }}"
                                    required placeholder="Nhập email (nếu có)"
                                    class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1">
                                @if ($errors->has('email'))
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <select id="target_customer_group" name="target_customer_group_id"
                                    ...
                                    @foreach ($targetCustomerGroups as $target_customer_group)
                                        <option value="{{ $target_customer_group->id }}"
                                            {{ old('target_customer_group_id') == $target_customer_group->id ? 'selected' : '' }}>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="border" style="padding: 20px; border-radius: 10px;">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <input id="awards" name="awards" type="text"
                                    class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1"
                                    value="{{ old('awards') }}" placeholder="Nhập giải thưởng">
                            </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <input id="commendations" name="commendations" type="text"
                                    class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1"
                                    value="{{ old('commendations') }}" placeholder="Nhập bằng khen, giấy khen">
                            </div>
                        </div>
                        ...
                        <div class="border" style="padding: 20px; border-radius: 10px;">
                            <div id="responsible_people">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <label for="position" class="form-label mb-0 me-2" style="width: 250px;">Chức vụ
                                        <span class="text-danger">*</span></label>
