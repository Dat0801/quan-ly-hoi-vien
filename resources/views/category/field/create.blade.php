        ...
        <div class="p-4 bg-white shadow-sm rounded-lg w-100" style="max-height: 80vh; overflow-y: auto;">
            ...
            <form action="{{ route('field.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea id="description" name="description" rows="3"
                            class="form-control border-gray-300 shadow-sm focus:ring-indigo-500"></textarea>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end mb-3">
                    <button type="button" class="btn btn-outline-secondary" onclick="addSubGroup()">Thêm nhóm
                        con</button>
                </div>
