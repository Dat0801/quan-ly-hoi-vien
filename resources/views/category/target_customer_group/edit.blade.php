        ...
        <div class="p-4 bg-white shadow-sm rounded-lg w-100">
            ...
            <form action="{{ route('target_customer_group.update', $group->id) }}" method="POST">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <a href="{{ route('target_customer_group.show', $group->id) }}" class="btn btn-outline-primary w-48 py-3 sm:rounded-lg">Hủy</a>
                    <button type="submit" class="btn btn-primary w-48 py-3 sm:rounded-lg">Cập Nhật</button>
                </div>
            </form>
        </div>
    </div>
