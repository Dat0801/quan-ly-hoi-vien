                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="market_code" name="market_code" 
                               ...
                               value="{{ old('market_code', $market->market_code) }}" required>
                        @error('market_code')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="market_name" name="market_name" 
                               class="form-control border-gray-300 shadow-sm focus:ring-indigo-500" 
                               value="{{ old('market_name', $market->market_name) }}" required>
                        @error('market_name')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea id="description" name="description" rows="3" 
                                  class="form-control border-gray-300 shadow-sm focus:ring-indigo-500">{{ old('description', $market->description) }}</textarea>
                    </div>
                </div>
