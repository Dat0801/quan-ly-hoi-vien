            ...
            <form action="{{ route('business.update', $business->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="business_code" class="form-label">Mã Doanh Nghiệp <span
                        ...
                        <input type="text" id="business_code" name="business_code"
                            ...
                            value="{{ old('business_code', $business->business_code) }}" required>
                        @error('business_code')
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea id="description" name="description" rows="3"
                            class="form-control border-gray-300 shadow-sm focus:ring-indigo-500">{{ old('description', $business->description) }}</textarea>
                    </div>
                </div>

                <div class="d-flex justify-content-center gap-3">
                    <x-cancel-button :route="route('business.show', $business->id)">
                        Hủy
                    </x-cancel-button>
                    <x-primary-button>
                        Lưu
