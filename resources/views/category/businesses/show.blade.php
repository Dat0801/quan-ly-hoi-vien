        ...
        <div class="p-4 bg-white shadow-sm rounded-lg w-100">
            ...
            <form>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="business_code" name="business_code"
                            ...
                            value="{{ $business->business_code }}" disabled>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea id="description" name="description" rows="3"
                            class="form-control border-gray-300 shadow-sm focus:ring-indigo-500" disabled>{{ $business->description }}</textarea>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-center gap-3">
                    ...
                    <x-primary-button :route="route('business.edit', $business->id)">
                        Chỉnh sửa
                    </x-primary-button>
                </div>
            </form>
