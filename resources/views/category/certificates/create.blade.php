            ...
            <form action="{{ route('certificates.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="certificate_code" name="certificate_code" class="form-control border-gray-300 shadow-sm focus:ring-indigo-500" value="{{ old('certificate_code') }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="certificate_name" class="form-label">Tên Chứng Chỉ <span class="text-danger">*</span></label>
                        <input type="text" id="certificate_name" name="certificate_name" class="form-control border-gray-300 shadow-sm focus:ring-indigo-500" value="{{ old('certificate_name') }}" required>
                ...
                <div class="d-flex justify-content-center gap-3">
                    <a href="{{ route('certificates.index') }}" class="btn btn-outline-primary w-48 py-3 sm:rounded-lg">Hủy</a>
