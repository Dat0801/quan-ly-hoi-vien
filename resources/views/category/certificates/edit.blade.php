            ...
            <form action="{{ route('certificates.update', $certificate->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="certificate_code" name="certificate_code" class="form-control border-gray-300 shadow-sm" value="{{ $certificate->certificate_code }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="certificate_name" name="certificate_name" class="form-control border-gray-300 shadow-sm" value="{{ $certificate->certificate_name }}" required>
