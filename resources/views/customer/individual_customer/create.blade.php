                        ...
                        <div class="border mb-3" style="border-radius: 10px; padding: 20px;">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <input type="text" id="position" name="unit_position"
                                    value="{{ old('unit_position') }}" placeholder="Nhập chức vụ"
                                    class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="border mb-3" style="border-radius: 10px; padding: 20px;">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_board_member" id="is_board_member_yes" value="1" required
                                        {{ old('is_board_member') == '1' ? 'checked' : '' }} onclick="toggleBoardMemberFields(true)">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_board_member" id="is_board_member_no" value="0" required
                                        {{ old('is_board_member') == '0' ? 'checked' : '' }} onclick="toggleBoardMemberFields(false)">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <input type="text" id="term" name="term" value="{{ old('term') }}" placeholder="Nhập nhiệm kỳ" 
                                    class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1"
                                    {{ old('is_board_member') == '1' ? 'required' : '' }}>
                                @if ($errors->has('term'))
...
<script>
    ...
    const isBoardMember = {{ old('is_board_member') == '1' ? 'true' : 'false' }};
