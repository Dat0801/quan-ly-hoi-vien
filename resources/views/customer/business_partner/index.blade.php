<x-app-layout>
    <div class="d-flex align-items-start">
                ...
                <div class="tab-pane fade show active" id="business-partner-info" role="tabpanel">
                    <div class="bg-white sm:rounded-lg">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <form id="partnerCategorySelectForm" method="GET" action="{{ route('business_partner.index') }}" class="d-flex" onchange="this.submit()">
                            ...
                            <div class="ms-2">
                                <form id="partnerSearchForm" method="GET"
                                    action="{{ route('business_partner.index') }}" class="d-flex">
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu"
                                                        ...
                                                        <li>
                                                            <a href="{{ route('business_partner.show', $partner->id) }}"
                                                                class="dropdown-item" style="color: #BF5805">
                                                                Chi tiết
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ route('business_partner.edit', $partner->id) }}"
                                                                class="dropdown-item" style="color: #BF5805">
                                                                Chỉnh sửa
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <form
                                                                action="{{ route('business_partner.destroy', $partner->id) }}"
                                                                method="POST"
                                                        ...
                                                        <li>
                                                            <a href="{{ route('business_partner.membership-fee-history', $partner->id) }}" 
                                                                class="dropdown-item" style="color: #BF5805">
        ...
        <div class="d-flex flex-column justify-content-between ms-4 bg-white sm:rounded-lg" id="addNewButtonContainer">
            <a href="{{ route('business_partner.create') }}"
