<x-app-layout>
    ...
    <div class="d-flex align-items-start" style="margin-right: 110px;">
        <div class="p-4 bg-white shadow-sm rounded-lg w-100" style="max-height: 85vh; overflow-y: auto;">
            ...
            <form action="{{ route('business_customer.update', $customer->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                        ...
                        <div class="border" style="border-radius: 10px; padding: 20px;">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <input type="text" id="headquarters_address" name="headquarters_address"
                                    ...
                                    placeholder="Nhập địa chỉ trụ sở chính" required
                                    class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <input type="email" id="email" name="email"
                                    ...
                                    placeholder="Nhập email (nếu có)" required
                                    class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1">
                                @if ($errors->has('email'))
                                    ...
                                    <select id="industry" name="industry_id"
                                        ...
                                        @foreach ($industries as $industry)
                                            <option value="{{ $industry->id }}"
                                                {{ $industry->id == $customer->industry_id ? 'selected' : '' }}>
                                    ...
                                    <select id="field_id" name="field_id"
                                        ...
                                        @foreach ($fields as $field)
                                            <option value="{{ $field->id }}"
                                                {{ $field->id == $customer->field_id ? 'selected' : '' }}>
                                                {{ $field->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <select id="market" name="market_id"
                                    ...
                                    @foreach ($markets as $market)
                                        <option value="{{ $market->id }}"
                                            {{ $market->id == $customer->market_id ? 'selected' : '' }}>
                                            {{ $market->market_name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select id="target_customer_group" name="target_customer_group_id"
                                    ...
                                    @foreach ($targetCustomerGroups as $group)
                                        <option value="{{ $group->id }}"
                                            {{ $group->id == $customer->target_customer_group_id ? 'selected' : '' }}>
                                            {{ $group->group_name }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="border" style="padding: 20px; border-radius: 10px;">
                            <div class="d-flex justify-content-between w-100">
                                ...
                                <div class="form-check form-check-inline w-25">
                                    <input class="form-check-input" type="radio" name="business_scale"
                                        id="scale_100_200" value="100-200"
                                ...
                                <div class="form-check form-check-inline w-25">
                                    <input class="form-check-input" type="radio" name="business_scale"
                                        id="scale_200_500" value="200-500"
                        ...
                        <div class="border" style="padding: 20px; border-radius: 10px;">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <select id="certificate_id" name="certificate_id"
                                    class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1">
                                    @if ($customer->certificate_id == null)
                                        <option value="">Chọn chứng chỉ</option>
                                    @endif
                                    @foreach ($certificates as $certificate)
                                        <option value="{{ $certificate->id }}"
                                            {{ $certificate->id == $customer->certificate_id ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="leader_gender_male">Nam</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="leader_gender" required
                                            id="leader_gender_female" value="female"
                                            {{ old('leader_gender', $customer->leader_gender ?? '') == 'female' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="leader_gender_female">Nữ</label>
                                    </div>
                                </div>
