<x-app-layout>
    <div class="d-flex align-items-start">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="d-flex">
                                <div class="me-2">
                                    ...
                                    <form id="filterForm" method="GET" action="{{ route('business_customer.index') }}"
                            ...
                            <div class="ms-2">
                                <form id="customerSearchForm" method="GET"
                                    action="{{ route('business_customer.index') }}" class="d-flex">
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu"
                                                        ...
                                                        <li>
                                                            <a href="{{ route('business_customer.show', $customer->id) }}"
                                                        ...
                                                        <li>
                                                            <form
                                                                action="{{ route('business_customer.destroy', $customer->id) }}"
                                                                method="POST"
                                                        ...
                                                        <li>
                                                            <a href="{{ route('business_customer.sponsorship_history', $customer->id) }}" 
                                                                class="dropdown-item" style="color: #BF5805">
                                                                Lịch sử tài trợ
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ route('business_customer.membership-fee-history', $customer->id) }}" 
                                                                class="dropdown-item" style="color: #BF5805">
        ...
        <div class="d-flex flex-column justify-content-between ms-4 bg-white sm:rounded-lg" id="addNewButtonContainer">
            <a href="{{ route('business_customer.create') }}"
