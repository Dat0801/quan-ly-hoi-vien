    ...
    <div class="d-flex align-items-start" style="margin-right: 110px;">
        <div class="p-4 bg-white shadow-sm rounded-lg w-100" style="max-height: 85vh; overflow-y: auto;">
            <h1
                ...
                Chỉnh sửa thông tin khách hàng</h1>

            <form action="{{ route('board_customer.update', $customer->id) }}" method="POST"
                ...
                <div class="row">
                        ...
                        <div class="border mb-3" style="border-radius: 10px; padding: 20px;">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <input type="text" id="card_code" name="card_code"
                                    value="{{ old('card_code', $customer->card_code) }}" placeholder="Nhập mã thẻ"
                                    class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1"
                                    disabled>
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <input type="text" id="full_name" name="full_name"
                                    value="{{ old('full_name', $customer->full_name) }}" placeholder="Nhập họ và tên"
                                    class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1"
                                    required>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="avatar-upload-box position-relative" style="width: 120px; height: 120px;">
                                    <input type="file" id="avatar" name="avatar"
                                        class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1 position-absolute w-100 h-100 opacity-0"
                                        onchange="previewImage(event)">

                                    <div class="avatar-preview position-absolute top-0 left-0 w-100 h-100 d-flex justify-content-center align-items-center rounded-3"
                                        style="background-color: #f0f0f0;">
                                        @if (!isset($customer) || !$customer->avatar)
                                            <i id="avatar-icon" class="bi bi-camera"
                                                style="font-size: 50px; color: #888; cursor: pointer;"
                    ...
                    <div class="col-lg-6">
                        <h3 class="p-2"
                            style="font-family: 'Roboto', sans-serif; font-size: 16px; font-weight: 700; line-height: 38.4px; color: #803B03;">
                            2. Thông tin đơn vị</h3>
                        <div class="border" style="border-radius: 10px; padding: 20px;">
                            <!-- Tên đơn vị -->
                            <div class="d-flex align-items-center mb-3">
                                <label for="organization_name" class="form-label mb-0 me-2" style="width: 250px;">Tên
                                    đơn vị</label>
                                <input type="text" id="organization_name" name="unit_name"
                                    value="{{ old('unit_name', $customer->unit_name) }}"
                            ...
                            <!-- Loại hình đơn vị -->
                            <div class="d-flex align-items-center">
                                <label for="organization_type" class="form-label mb-0 me-2"
                                    style="width: 250px;">Chức vụ</label>
                                <input type="text" id="organization_type" name="unit_position"
                                    value="{{ old('unit_position', $customer->unit_position) }}"
                                    placeholder="Nhập loại hình đơn vị"
                                    class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1">
                        ...
                        <div class="border" style="border-radius: 10px; padding: 20px;">
                            <!-- Chức danh -->
                            <div class="d-flex align-items-center mb-3">
                                <label for="title" class="form-label mb-0 me-2" style="width: 250px;">Chức
                                    danh</label>
                                <input type="text" id="title" name="association_position"
                                    value="{{ old('association_position', $customer->association_position) }}"
                            ...
                            <!-- Nhiệm kỳ -->
                            <div class="d-flex align-items-center mb-3">
                                <label for="term" class="form-label mb-0 me-2" style="width: 250px;">Nhiệm
                                    kỳ</label>
                                <input type="text" id="term" name="term"
                                    value="{{ old('term', $customer->term) }}" placeholder="Nhập nhiệm kỳ"
                                    class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1"
                                    required>
                                @if ($errors->has('term'))
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="attendance_permission"
                                        id="attendance_permission_yes" value="1"
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="attendance_permission"
                                        id="attendance_permission_no" value="0"
                                ...
                                @if ($errors->has('attendance_permission'))
                                    <span
                                        class="text-danger ms-2">{{ $errors->first('attendance_permission') }}</span>
                                @endif
                            </div>
                        </div>
                ...
                <div class="d-flex justify-content-center gap-3">
                    <a href="{{ route('board_customer.index') }}"
