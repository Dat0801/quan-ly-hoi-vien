<x-app-layout>
    ...
    <div class="d-flex align-items-start" style="margin-right: 110px;">
        <div class="p-4 bg-white shadow-sm rounded-lg w-100" style="max-height: 85vh; overflow-y: auto;">
            ...
            <form action="{{ route('individual_partner.update', $partner->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                                ...
                                <select id="industry" name="industry_id"
                                    ...
                                    @foreach ($industries as $industry)
                                        <option value="{{ $industry->id }}"
                                            {{ old('industry_id', $partner->industry_id) == $industry->id ? 'selected' : '' }}>
                                ...
                                <select id="field" name="field_id"
                                    ...
                                    @foreach ($fields as $field)
                                        <option value="{{ $field->id }}"
                                            {{ old('field_id', $partner->field_id) == $field->id ? 'selected' : '' }}>
                                            {{ $field->name }}
                                        </option>
                                    @endforeach
                                </select>
