<x-app-layout>
    <div class="d-flex align-items-start">
                    ...
                    <div class="bg-white sm:rounded-lg">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <form id="partnerCategorySelectForm" method="GET"
                                action="{{ route('individual_partner.index') }}" class="d-flex"
                            ...
                            <form id="partnerSearchForm" method="GET" action="{{ route('individual_partner.index') }}"
                                class="d-flex">
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu"
                                                        ...
                                                        <li>
                                                            <a href="{{ route('individual_partner.show', $partner->id) }}"
                                                        ...
                                                        <li>
                                                            <form
                                                                action="{{ route('individual_partner.destroy', $partner->id) }}"
                                                                method="POST"
                                                        ...
                                                        <li>
                                                            <a href="{{ route('individual_partner.membership-fee-history', $partner->id) }}" 
                                                                class="dropdown-item" style="color: #BF5805">
        ...
        <div class="d-flex flex-column justify-content-between ms-4 bg-white sm:rounded-lg" id="addNewButtonContainer">
            <a href="{{ route('individual_partner.create') }}"
