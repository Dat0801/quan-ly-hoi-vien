    ...
    <div class="d-flex align-items-start" style="margin-right: 110px;">
        <div class="p-4 bg-white shadow-sm rounded-lg w-100" style="max-height: 85vh; overflow-y: auto;">
            <h1 style="font-family: 'Roboto', sans-serif; font-size: 32px; font-weight: 700; line-height: 38.4px; color: #803B03;"
                class="mb-3">Chỉnh sửa người dùng</h1>
            ...
            <form action="{{ route('account.update', $account->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="border mb-3" style="border-radius: 10px; padding: 20px;">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <label for="email" class="form-label mb-0 me-2" style="width: 250px;">Tên đăng nhập
                                    <span class="text-danger">*</span></label>
                                <input type="email" id="email" name="email"
                                    value="{{ old('email', $account->email) }}" placeholder="Nhập email"
                            ...
                            <!-- Tên người dùng -->
                            <div class="d-flex align-items-center mb-3">
                                <label for="name" class="form-label mb-0 me-2" style="width: 250px;">Họ và tên <span
                                        class="text-danger">*</span></label>
                                <input type="text" id="name" name="name"
                                    value="{{ old('name', $account->name) }}" placeholder="Nhập họ và tên"
                                    class="form-control border-gray-300 shadow-sm focus:ring-indigo-500 flex-grow-1"
                                    disabled>
                                @if ($errors->has('name'))
                            ...
                            <!-- Mật khẩu -->
                            <div class="d-flex align-items-center mb-3">
                                <label for="password" class="form-label mb-0 me-2" style="width: 250px;">Mật khẩu <span
                                        class="text-danger">*</span></label>
                            ...
                            <!-- Xác nhận mật khẩu -->
                            <div class="d-flex align-items-center mb-3">
                                <label for="password_confirmation" class="form-label mb-0 me-2"
                                    style="width: 250px;">Xác nhận mật khẩu <span class="text-danger">*</span></label>
                    ...
                    <div class="col-lg-6">
                        <div class="border mb-3" style="border-radius: 10px; padding: 20px;">
                            <!-- Số điện thoại -->
                            <div class="d-flex align-items-center mb-3">
                                <label for="phone_number" class="form-label mb-0 me-2" style="width: 250px;">Số điện
                                    thoại</label>
                            ...
                            <!-- Vai trò -->
                            <div class="d-flex align-items-center mb-3">
                                <label for="role_id" class="form-label mb-0 me-2" style="width: 250px;">Vai trò <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <label for="status" class="form-label mb-0 me-2" style="width: 180px;">Trạng
                                    thái</label>
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="status_active" name="status" value="1"
                                            ...
                                            {{ old('status', $account->status) == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="status_inactive" name="status" value="0"
                                            class="form-check-input border-gray-300 shadow-sm focus:ring-indigo-500"
                                            {{ old('status', $account->status) == '0' ? 'checked' : '' }}>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="avatar-upload-box position-relative" style="width: 120px; height: 120px;">
                                    ...
                                    <div class="avatar-preview position-absolute top-0 left-0 w-100 h-100 d-flex justify-content-center align-items-center rounded-3"
                                        ...
                                        <img id="avatar-image"
                                            class="hidden img-fluid w-100 h-100 object-fit-cover rounded-3"
                                            src="{{ $account->avatar }}" alt="Selected Avatar"
                ...
                <div class="d-flex justify-content-center gap-3">
                    <x-cancel-button :route="route('account.index')">
                        Hủy
                    </x-cancel-button>
                    <x-primary-button>
                        Lưu
