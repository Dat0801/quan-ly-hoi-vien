...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('business_customers', function (Blueprint $table) {
            ...
            $table->foreignId('connector_leader_id')->nullable()->constrained('connectors')->nullOnDelete(); // Lãnh đạo đơn vị
            $table->foreignId('connector_manager_id')->nullable()->constrained('connectors')->nullOnDelete(); // Phụ trách kết nối
