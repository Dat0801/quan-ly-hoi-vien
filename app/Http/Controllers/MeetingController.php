...
class MeetingController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->has('selected_members')) {
            $existingParticipants = $meeting->participants->pluck('participantable_id')->toArray();
            $newParticipants = array_column($request->selected_members, 'id');

            $participantsToRemove = array_diff($existingParticipants, $newParticipants);
            MeetingParticipant::whereIn('participantable_id', $participantsToRemove)
